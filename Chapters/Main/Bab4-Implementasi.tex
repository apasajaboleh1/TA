...
Implementasi algoritma dengan teknik \textit{Kasiski Examination} untuk menyelesaikan \textit{The Bytelandian Cryptographer (Act IV)} untuk membutuhkan 4 \textit{header} yaitu {\fontfamily{lmss}\selectfont cstdio, cstring, algorithm, dan unordered\verb|_|map} . Seperti yang terdapat pada Kode Sumber \ref{source:implementasi_header}.
