...
\begin{minipage}{\linewidth}
\resizebox{\textwidth}{!}{%
\lstinputlisting[language=C++, firstline=26, lastline=56, caption=Fungsi SOLVE, label=source:fungsi_SOLVE]{Chapters/Details/bab4/crypto4.cpp}}
\end{minipage} 

\begin{minipage}{\linewidth}
\resizebox{\textwidth}{!}{%
\lstinputlisting[language=C++, firstline=57, lastline=67, caption=Fungsi SOLVE, label=source:fungsi_SOLVE1]{Chapters/Details/bab4/crypto4.cpp}}
\end{minipage} 
...
\begin{table}[H]
		...
		\begin{tabular}   {p{0.5cm}|p{2.5cm}|p{2cm}|p{4cm}|}\hline
		No&Nama Variabel&Tipe Data&Penjelasan \\ \hline
		1&ntofind&integer&Digunakan untuk menghitung jumlah \ciphertext tidak bernilai '*' dan \plaintext bernilai '*'. \\ \hline
